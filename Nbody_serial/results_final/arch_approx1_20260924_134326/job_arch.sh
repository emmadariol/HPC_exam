...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/arch_approx1_20260924_134326 N=100000 NSTEPS=10 RANKS=32 THREADS=1 RSQRT=approx1 REPEATS=5 WARMUPS=1 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0 DT=0.0001 EPS=0.05
