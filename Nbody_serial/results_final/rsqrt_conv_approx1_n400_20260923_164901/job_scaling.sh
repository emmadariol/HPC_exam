...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/rsqrt_conv_approx1_n400_20260923_164901 SCALING_KINDS=strong STRONG_N=10000 NSTEPS=400 DT=0.000025 RANKS=1 THREADS=8 COMM=sendrecv RSQRT=approx1 ACCUMULATORS=4 ENERGY_EVERY=1 EPS=0.05 REPEATS=3 WARMUPS=0 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0
