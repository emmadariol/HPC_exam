...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/energy_long_20260923_170127 SCALING_KINDS=strong STRONG_N=10000 NSTEPS=2000 RANKS=1 THREADS=8 COMM=sendrecv RSQRT=exact ACCUMULATORS=4 ENERGY_EVERY=10 REPEATS=1 WARMUPS=0 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0 DT=0.0001 EPS=0.05
