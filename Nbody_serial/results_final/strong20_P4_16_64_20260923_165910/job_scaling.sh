...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/strong20_P4_16_64_20260923_165910 SCALING_KINDS=strong STRONG_N=100000 NSTEPS=20 RANKS=4\ 16\ 64 THREADS=1 COMM=sendrecv KERNEL=direct RSQRT=exact ACCUMULATORS=4 ENERGY_EVERY=20 REPEATS=5 WARMUPS=1 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0 DT=0.0001 EPS=0.05
