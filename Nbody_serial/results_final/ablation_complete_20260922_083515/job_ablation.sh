...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/ablation_complete_20260922_083515 N=10000 NSTEPS=5 RANKS=1 THREADS=1 REPEATS=5 WARMUPS=0 DT=1e-4 EPS=0.05 ENERGY_EVERY=100 KEEP_ALL_REPETITIONS=1
