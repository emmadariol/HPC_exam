...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/ablation_T8_20260923_165910 N=10000 NSTEPS=5 RANKS=1 THREADS=8 ENERGY_EVERY=100 REPEATS=5 WARMUPS=1 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0 DT=0.0001 EPS=0.05
