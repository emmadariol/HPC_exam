...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/mapping_socket HYBRID_PAIRS=2x32 N=20000 NSTEPS=20 REPEATS=5 WARMUPS=1 VERIFY_MAPPING=socket
