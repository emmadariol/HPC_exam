...
export RESULT_DIR=/u/dssc/emmadariol/HPC_exam/Nbody_serial/runs/overlap_20260923_132533/P8_sendrecv SCALING_KINDS=strong STRONG_N=100000 NSTEPS=20 RANKS=8 THREADS=1 REPEATS=5 WARMUPS=1 COMM=sendrecv KERNEL=direct RSQRT=exact ACCUMULATORS=4 DT=0.0001 EPS=0.05 ENERGY_EVERY=20 KEEP_ALL_REPETITIONS=1 USE_CONTAINER=0
